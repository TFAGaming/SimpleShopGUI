...
public class ShopGUIFood {
    public static void create(Player player) {
        List<List<Object>> listedItems = ShopDatabaseManager.getListedItemsByCategory(Category.FOOD, false);
        ...
        PaginationGUI pagegui = new PaginationGUI(player, 6,
                ChatColorTranslator.translate(Plugin.config.getString("gui.shop_category.titles.FOOD")),
                total_pages);

        ShopGUI.playerSelectedCategory.put(player.getUniqueId(), Category.FOOD);
