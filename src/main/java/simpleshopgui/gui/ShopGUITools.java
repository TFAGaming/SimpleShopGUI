...
public class ShopGUITools {
    public static void create(Player player) {
        List<List<Object>> listedItems = ShopDatabaseManager.getListedItemsByCategory(Category.TOOLS, false);
        ...
        PaginationGUI pagegui = new PaginationGUI(player, 6,
                ChatColorTranslator.translate(Plugin.config.getString("gui.shop_category.titles.TOOLS")),
                total_pages);

        ShopGUI.playerSelectedCategory.put(player.getUniqueId(), Category.TOOLS);
