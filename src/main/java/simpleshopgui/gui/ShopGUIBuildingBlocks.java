...
public class ShopGUIBuildingBlocks {
    public static void create(Player player) {
        List<List<Object>> listedItems = ShopDatabaseManager.getListedItemsByCategory(Category.BUILDING_BLOCKS, false);
        ...
        PaginationGUI pagegui = new PaginationGUI(player, 6,
                ChatColorTranslator.translate(Plugin.config.getString("gui.shop_category.titles.BUILDING_BLOCKS")),
                total_pages);

        ShopGUI.playerSelectedCategory.put(player.getUniqueId(), Category.BUILDING_BLOCKS);
