...
public class ShopGUIMiscellaneous {
    public static void create(Player player) {
        List<List<Object>> listedItems = ShopDatabaseManager.getListedItemsByCategory(Category.MISCELLANEOUS, false);
        ...
        PaginationGUI pagegui = new PaginationGUI(player, 6,
                ChatColorTranslator.translate(Plugin.config.getString("gui.shop_category.titles.MISCELLANEOUS")),
                total_pages);

        ShopGUI.playerSelectedCategory.put(player.getUniqueId(), Category.MISCELLANEOUS);
