...
public class ShopGUIMinerals {
    public static void create(Player player) {
        List<List<Object>> listedItems = ShopDatabaseManager.getListedItemsByCategory(Category.MINERALS, false);
        ...
        ShopGUI.playerSelectedCategory.put(player.getUniqueId(), Category.MINERALS);
