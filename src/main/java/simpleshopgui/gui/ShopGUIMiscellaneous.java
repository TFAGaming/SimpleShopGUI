...
public class ShopGUIMiscellaneous {
    public static void create(Player player) {
        List<List<Object>> listed_items = ShopDatabaseManager.getListedItemsByCategory("Miscellaneous", false);
        ...
        PaginationGUI pagegui = new PaginationGUI(player, 6,
                ...
                total_pages);
        ShopGUI.playerCurrentCategory.put(player.getUniqueId(), "Miscellaneous");
