...
public class ShopGUIBuildingBlocks {
    public static void create(Player player) {
        List<List<Object>> listed_items = ShopDatabaseManager.getListedItemsByCategory("Building Blocks", false);
        ...
        PaginationGUI pagegui = new PaginationGUI(player, 6,
                ...
                total_pages);
        ShopGUI.playerCurrentCategory.put(player.getUniqueId(), "Building Blocks");
